...
import { Calendar, Camera, Droplets, Dumbbell, Home, LogOut, MessageCircle, Settings, Drumstick, Refrigerator } from "lucide-react";
  ...
  >
    <div className="p-6">
      ...
      <nav className="space-y-2">
        ...
        <NavigationItem
          icon={Refrigerator}
          label="Fridge Food Detector"
          value="fridgeDetector"
          active={activeTab === "fridgeDetector"}
        />
        {/* <NavigationItem
          icon={Calendar}
          label="Schedule"
